    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-10 me-auto mb-4">
                <h4 class="text-white mb-3"><a href="index.php">SG</a> AMAL</h4>
                <p class="copyright-text text-muted mt-lg-5 mb-4 mb-lg-0">
                    Copyright © <span id="year"></span> <strong>SG AMAL</strong>
                </p> <br>
                <p class="copyright-text">Developed by<a href="https://github.com/SpaceSpider05" target="_blank">Space Spider</a></p>
            </div>
